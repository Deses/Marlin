...
// Edited for Deses-Ender3
  ...
  #define MANUAL_FEEDRATE { 60*60, 60*60, 10*60, 5*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.24    // Unit: mm compression per 1mm/s extruder speed
...
// Edited for Deses-Ender3
  ...
  #define PROBING_MARGIN_FRONT 16.25
