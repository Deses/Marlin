...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Regular 3mm thick Glass
  #define DEFAULT_bedKp 52.04
  #define DEFAULT_bedKi 9.84
  #define DEFAULT_bedKd 183.54
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 144.5 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-41, -9, -0.74}

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 41

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_SPEED 100*70
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 41, 41, 41, 41 } // (mm) Left, Front, Right, Back insets
