...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb & Deses12, Ender-3)" // Who made the changes.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 86.67
  #define DEFAULT_bedKi 14.26
  #define DEFAULT_bedKd 351.32
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.7, 79.7, 401, 396.7 } // Dragonfly BMS + BMG Clone
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 250, 150 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -54.5, -23.3, -0.80 }
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE    9 // (mm) Z Clearance for Deploy/Stow
...
#define HOMING_FEEDRATE_MM_M { (40*60), (40*60), (5*60) }
